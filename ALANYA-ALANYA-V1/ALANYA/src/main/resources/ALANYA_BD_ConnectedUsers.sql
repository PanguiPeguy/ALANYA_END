...
CREATE TABLE `ConnectedUsers` (
  `connectedUserID` int NOT NULL AUTO_INCREMENT,
  `ipAdress` varchar(50) NOT NULL,
  `timeLastConnection` time NOT NULL,
  `status` tinyint(1) NOT NULL,
  `userID` int NOT NULL,
  PRIMARY KEY (`connectedUserID`),
  KEY `userID` (`userID`),
  CONSTRAINT `ConnectedUsers_ibfk_1` FOREIGN KEY (`userID`) REFERENCES `Users` (`userID`)
